...
describe('PaginationControls', () => {
  it('PaginationControls - first page - Previous button is disabled', () => {
    render(
      <PaginationControls currentPage={0} totalPages={5} onPageChange={() => {}} />,
    )
  ...
  it('PaginationControls - last page - Next button is disabled', () => {
    render(
      <PaginationControls currentPage={4} totalPages={5} onPageChange={() => {}} />,
    )
  ...
  it('PaginationControls - Previous click - calls onPageChange with currentPage minus 1', async () => {
    ...
    render(
      <PaginationControls currentPage={2} totalPages={5} onPageChange={handlePageChange} />,
    )
